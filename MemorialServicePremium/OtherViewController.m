...
- (void)viewDidLoad
{
    ...
    _menuItemTerms              = @"利用規約";
    _menuItemModelChangeKey     = @"機種変更キー";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([selectedKey compare:MENU_KEY_MODEL_CHANGE_KEY] == NSOrderedSame) {
        //機種変更キーのインスタンスを生成
        OtherDataTransferKeyNoticeViewController *otherdataTransferKeyNoticeViewController = [OtherDataTransferKeyNoticeViewController new];
        
        //機種変更キー画面に遷移
        [self.navigationController pushViewController:otherdataTransferKeyNoticeViewController animated:YES];
