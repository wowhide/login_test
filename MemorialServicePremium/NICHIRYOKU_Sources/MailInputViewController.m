...
- (void)viewDidLoad
{
    ...
    //ツールバーの背景色と文字色を設定
    self.topToolBar.barTintColor = [UIColor colorWithRed:TOOLBAR_BG_COLOR_RED green:TOOLBAR_BG_COLOR_GREEN blue:TOOLBAR_BG_COLOR_BLUE alpha:1.0];
    self.topToolBar.tintColor = [UIColor colorWithRed:TEXT_COLOR_RED green:TEXT_COLOR_GREEN blue:TEXT_COLOR_BLUE alpha:1.0];
...
-(void)viewDidLayoutSubviews{
    ...
    [self.sentenceRuleTextView setContentOffset:CGPointZero animated:NO];
