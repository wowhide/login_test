...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //    [httpAccess deletedeceasename:DESEASE_LIST_DELETE param:parameter];
    //    NSLog(@"DELETE%@", parameter);
...
//            NSString *saveFileName = [NSString stringWithFormat:@"%@.jpg",_deceased.deceased_id];
        ...
        [deceasedNsmd setValue:[NSString stringWithFormat:@"%d", _deceased.deceased_no] forKey:@"deceased_no"];
        [deceasedNsmd setValue:_deceased.deceased_id forKey:@"deceased_id"];
        [deceasedNsmd setValue:[NSString stringWithFormat:@"%d", _deceased.qr_flg] forKey:@"qr_flg"];
        [deceasedNsmd setValue:_deceased.deceased_name forKey:@"deceased_name"];
        [deceasedNsmd setValue:_deceased.deceased_birthday forKey:@"deceased_birthday"];
        [deceasedNsmd setValue:_deceased.deceased_deathday forKey:@"deceased_deathday"];
        [deceasedNsmd setValue:[NSString stringWithFormat:@"%d", _deceased.kyonen_gyonen_flg] forKey:@"kyonen_gyonen_flg"];
        [deceasedNsmd setValue:[NSString stringWithFormat:@"%d", _deceased.death_age] forKey:@"death_age"];
        [deceasedNsmd setValue:_deceased.deceased_photo_path forKey:@"deceased_photo_path"];
        [deceasedNsmd setValue:_deceased.entry_datetime forKey:@"entry_datetime"];
        [deceasedNsmd setValue:_deceased.timestamp forKey:@"timestamp"];
        ...
        if (transfer_download) {
            ...
            NSString *saveuserdata_urlAsString = UPDATE_DECEASED_NO;
