...
@property (weak, nonatomic) IBOutlet UILabel *morticianFaxLabel;

//くらしホール松山
@property (weak, nonatomic) IBOutlet UILabel *morticianTwoHoleName;
@property (weak, nonatomic) IBOutlet UIButton *morticianTwoTelButton;
@property (weak, nonatomic) IBOutlet UILabel *morticianTwoFaxLabel;
...
- (void)viewDidLoad
{
    ...
    float height = [[UIScreen mainScreen]bounds].size.height+15;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //FAX
    self.morticianFaxLabel.text = MORTICIAN_FAX;
    [self.morticianFaxLabel setNumberOfLines:0];
    [self.morticianFaxLabel sizeToFit];
    //住所
    ...
    //くらしホール松山
    //ホール名
    self.morticianTwoHoleName.text = MORTICIAN_TWO_HOLL_NAME;
    [self.morticianTwoHoleName setNumberOfLines:0];
    [self.morticianTwoHoleName sizeToFit];
    //電話番号
    [self.morticianTwoTelButton setTitle:MORTICIAN_TWO_TEL forState:UIControlStateNormal];
    //FAX
    self.morticianTwoFaxLabel.text = MORTICIAN_TWO_FAX;
    [self.morticianTwoFaxLabel setNumberOfLines:0];
    [self.morticianTwoFaxLabel sizeToFit];
    //住所
